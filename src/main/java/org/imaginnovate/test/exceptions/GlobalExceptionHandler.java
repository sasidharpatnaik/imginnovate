...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Value("${spring.boot.exception.trace:false}")
    ...
    public ResponseEntity<Object> handleNoSuchElementFoundException(EmployeeNotFoundException empNotFoundException, WebRequest request) {
        log.error("Failed to find the requested element", empNotFoundException);
